...
with open('../table/subject_dic.json', 'w') as f:
    json.dump(unicode_subject_dic, f)

stu_class_dic = {"\u7269\u7406\u7c7b": "2073",
                 "\u5386\u53f2\u7c7b": "2074",
                 "\u7406\u79d1": "1",
                 "\u6587\u79d1": "2",
                 "\u7efc\u5408": "3",
...
with open('../table/stu_class_dic.json', 'w') as f:
    json.dump(stu_class_dic, f)
